...
namespace DisconnectedEnvironment
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cbDepartemen.Enabled = false;
            cbDesignation.Items.Add("MANAGER");
            cbDesignation.Items.Add("AUTHOR");
            cbDesignation.Items.Add("DESIGNER");
            cbDepartemen.Items.Add("MARKETING");
            cbDepartemen.Items.Add("FINANCE");
            cbDepartemen.Items.Add("IDD");
        ...
        private void cmdSave_Click_1(object sender, EventArgs e)
        {
            ...
            dr[6] = cbDepartemen.SelectedItem;
            dt.Rows.Add(dr);
